...
export default {
    ...
    setup() {
        ...
        return {
            ...
            filteredAgents,
            selectedAgents,
            transactionDate // Exponer transactionDate para el template
        };
    }
};
</script>
        ...
        <div class="flex gap-6">
            ...
            <div class="w-full md:w-1/2 card p-4 flex flex-col gap-4 h-full">
                ...
                <div class="mb-6">
                    ...
                    <InputText id="transaction-id" type="text" class="w-full border rounded-lg p-3 focus:outline-none" placeholder="Enter Transaction ID" />
                </div>
